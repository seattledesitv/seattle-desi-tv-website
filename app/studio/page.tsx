...
export default function StudioDashboardPage() {
  ...
  async function loadCounts() {
    const [eventsResult, pendingEventsResult, approvedEventsResult, onHoldEventsResult, rejectedEventsResult, businessesResult, pendingBusinessesResult, crewResult, pendingCrewResult, volunteersResult, pendingVolunteersResult, teamResult, radioTeamResult, roleRequestsResult, coverageRequestsResult, videoWorkflowsResult, videoAdminApprovalsResult, videoCrewReviewsResult, videoPublishingReadyResult] = await Promise.all([
