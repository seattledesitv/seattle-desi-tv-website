...
function mergeSections(rows: any[]) { const map: any = {}; defaults.forEach((s) => { map[s.section_key] = { ...s }; }); (rows || []).forEach((s) => { map[s.section_key] = { ...(map[s.section_key] || {}), ...s }; }); return Object.values(map).sort((a: any, b: any) => Number(a.display_order || 100) - Number(b.display_order || 100)); }
...
export default function Page() {
  ...
  async function moveMember(id: string, key: string, orderValue?: any) {
    ...
    const nextOrder = orderValue === "" || orderValue === null || orderValue === undefined ? 100 : Number(orderValue);
