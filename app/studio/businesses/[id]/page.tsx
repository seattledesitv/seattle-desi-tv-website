...
export default function BusinessEditPage() {
  ...
  async function loadBusiness(id: string) {
    ...
    const { data, error } = await supabase.from("local_businesses").select("id,name,address,website,category,discount,offer,poc_name,poc_email,poc_phone,image,status,approved").eq("id", id).maybeSingle();
  ...
  async function saveBusiness() {
    ...
    const { error } = await supabase.from("local_businesses").update(payload).eq("id", String(businessId));
