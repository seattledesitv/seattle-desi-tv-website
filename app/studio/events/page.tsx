...
export default function StudioEventsPage() {
  ...
  async function loadEvents() {
    const { data, error } = await supabase.from("events").select("id,title,date,location,description,status,image,image_urls,ticket_url,poc_email,poc_phone,created_at,featured,featured_order").order("date", { ascending: true });
