...
const groups = [
  ...
  { title: "Media", links: [["Video Production", "/studio/video-production"], ["Community Content", "/studio/community-content"], ["Instagram Publisher", "/studio/instagram-publisher"], ["Radio Team", "/studio/radio-team"], ["Radio Schedule", "/studio/radio-schedule"], ["Social Diagnostics", "/studio/social-diagnostics"]] },
  { title: "Communications", links: [["Newsletter", "/studio/newsletter"], ["Publishing Platform", "/studio/publishing"], ["Daily Digest Archive", "/studio/admin-digests"]] },
  { title: "Community", links: [["Businesses", "/studio/businesses"], ["Business Offers", "/studio/businesses/offers"], ["Classifieds", "/studio/classifieds"], ["Press Releases", "/studio/press-releases"], ["Matrimony", "/studio/matrimony"], ["Sponsor Onboarding", "/studio/sponsorships"], ["Event Ticketing", "/studio/ticketing"], ["Business Claims", "/studio/business-claims"], ["Listing Requests", "/studio/listing-requests"], ["Directory Generator", "/studio/directory-generator"], ["Premium Businesses", "/studio/businesses/premium"], ["Business Reviews", "/studio/business-reviews"], ["Community Groups", "/studio/community-groups"], ["Community Orgs", "/studio/community-orgs"], ["Premium Organizations", "/studio/community-orgs/premium"], ["Organization Requests", "/studio/organization-claims"], ["Organization Suggestions", "/studio/organization-suggestions"], ["Contact Requests", "/studio/contact-requests"]] },
  { title: "System", links: [["Finance Management", "/studio/finance"], ["Swirepay Webhooks", "/studio/swirepay-webhooks"], ["Analytics", "/studio/analytics"], ["Engagement Statistics", "/studio/engagement"], ["Database Backup", "/studio/database-backup"], ["Database Import", "/studio/database-import"]] },
];
