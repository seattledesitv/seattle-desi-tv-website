...
const configs = {
  groups: { table: "community_groups", title: "Indian Community Groups", kicker: "WhatsApp, Facebook, Telegram and local networks", subtitle: "Find Indian community groups around Seattle and submit groups that help the community connect.", addLabel: "Submit Community Group", loginNext: "/community-groups", urlLabel: "Group Link" },
  organizations: { table: "community_organizations", title: "Indian Community Organizations", kicker: "Nonprofits, associations, cultural groups and temples", subtitle: "Discover Indian community organizations and submit organizations for SDTV admin approval.", addLabel: "Submit Organization", loginNext: "/community-organizations", urlLabel: "Website / Page" },
};
function blank(kind: Kind) { return kind === "groups" ? { name: "", platform: "WhatsApp", category: "", language: "", location: "Seattle Area", description: "", group_url: "", contact_name: "", contact_email: "", contact_phone: "" } : { name: "", organization_type: "", category: "", location: "Seattle Area", website: "", description: "", contact_name: "", contact_email: "", contact_phone: "" }; }
