        ...
        <div className="grid gap-5 lg:grid-cols-[1fr_1.1fr] lg:items-center">
          <div>
            <p className="text-sm font-black uppercase tracking-wide text-pink-300">
              Subscribe to {site.shortName}
            </p>
            <h2 className="mt-2 text-2xl md:text-3xl font-black">
              Hear from us
            </h2>
            <p className="mt-3 text-sm leading-6 text-slate-300">
              Get {site.name} community updates, events, interviews, TV, radio,
              local business highlights, and special announcements.
            </p>
            <Link
              href="/subscribe"
              className="mt-3 inline-flex text-sm font-black text-pink-300 underline"
            >
              Open the full Subscribe page
            </Link>
          </div>
      ...
      <div className="max-w-7xl mx-auto mb-8 rounded-[2rem] border border-amber-100 bg-[#fffaf0] p-5 text-slate-950 shadow-2xl shadow-black/20 md:p-6">
        <div className="mb-4">
          <p className="text-sm font-black uppercase tracking-wide text-pink-600">
            Connect with {site.shortName}
          </p>
          <h3 className="mt-1 text-2xl font-black">
            Call, WhatsApp, or join the fan club
          </h3>
          {(site.settings.phone_display || site.settings.whatsapp_number) && (
      ...
      <div className="max-w-7xl mx-auto grid gap-8 md:grid-cols-2 xl:grid-cols-4">
        <div>
          ...
          <p className="text-slate-300 mt-3 text-sm leading-6">
            {String(
              site.settings.region_description ||
        ...
        <div>
          ...
          <div className="grid gap-2 text-sm text-slate-300">
            ...
            <a href="/community-disclaimer">
              Community &amp; No-Endorsement Disclaimer
            </a>
          </div>
          <div className="mt-6 border-t border-white/10 pt-5 text-sm text-slate-300">
            ...
            <a
              ...
              href="mailto:abharathkumar@gmail.com"
            >
