...
type TeamMember = { id: string; name: string; title: string; image: string; email?: string | null; user_id?: string | null; profile_photo_url?: string | null };
