...
type TeamMember = { id: string; name: string; title: string; image: string; email?: string | null; user_id?: string | null; profile_photo_url?: string | null; id_badge_url?: string | null };
...
export default function PublicTeamPage() {
  ...
  useEffect(() => {
    async function loadTeam() {
      const [teamResult, assignmentsResult, volunteerProfilesResult, userProfilesResult, hidden] = await Promise.all([
      ...
      const volunteerByEmail: Record<string, any> = {}; const userProfileByEmail: Record<string, any> = {}; const userProfileByUserId: Record<string, any> = {};
      ...
      if (teamResult.error) {
        ...
        setMembers((teamResult.data || []).filter((member: any) => !isPubliclyHidden(member, hidden)).map((member: any) => {
          ...
          return { ...member, profile_photo_url: baseProfile.profile_photo_url || volunteerProfile.photo_url || null, id_badge_url: baseProfile.id_badge_url || null };
        }));
      }
