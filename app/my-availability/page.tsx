...
export default function MyAvailabilityPage() {
  ...
  async function init() {
    ...
    setRole(nextRole);
    if (!isTeamRole(nextRole)) { setMessage("This page is for approved SDTV team members."); setLoading(false); return; }
