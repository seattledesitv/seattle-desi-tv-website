...
export default function EventsPage() {
  ...
  async function submitEvent() {
    ...
    try {
      ...
      const eventPayload: any = { ...form, ticket_url: safeExternalUrl(form.ticket_url) || null, image: imageUrls[0] || null, image_urls: imageUrls.length ? imageUrls : null, poc_email: form.poc_email.trim() || user.email || null, poc_phone: form.poc_phone.trim() || null, created_by: user.id, status: "pending", approved: false };
