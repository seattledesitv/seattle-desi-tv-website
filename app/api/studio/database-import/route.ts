...
const ALLOWED_TABLES = ["admins","community_groups","community_organizations","contact_requests","crew_availability","event_coverage_sources","event_crew_assignments","event_crew_media_submissions","event_deliverables","event_influencer_intents","event_video_notifications","event_video_revisions","event_video_workflows","events","featured_social_content","festival_hero_assets","hero_analytics","homepage_hero_banners","homepage_settings","homepage_sponsors","homepage_testimonials","influencer_profiles","local_businesses","matrimony_access_pricing","matrimony_access_requests","matrimony_profile_contacts","matrimony_profiles","newsletter_campaigns","newsletter_settings","newsletter_subscribers","notifications","public_content_requests","public_visibility_controls","radio_team_members","social_media_stats","sponsors","team_members","user_profiles","user_role_requests","volunteer_onboarding_submissions"];

const TABLE_PRIMARY_KEYS: Record<string, string[]> = {
  admins: ["user_id"], community_groups: ["id"], community_organizations: ["id"], contact_requests: ["id"], crew_availability: ["id"], event_coverage_sources: ["id"], event_crew_assignments: ["id"], event_crew_media_submissions: ["id"], event_deliverables: ["id"], event_influencer_intents: ["id"], event_video_notifications: ["id"], event_video_revisions: ["id"], event_video_workflows: ["id"], events: ["id"], featured_social_content: ["id"], festival_hero_assets: ["id"], hero_analytics: ["id"], homepage_hero_banners: ["id"], homepage_settings: ["site_id", "section_key"], homepage_sponsors: ["id"], homepage_testimonials: ["id"], influencer_profiles: ["id"], local_businesses: ["id"], matrimony_access_pricing: ["plan_key"], matrimony_access_requests: ["id"], matrimony_profile_contacts: ["profile_id"], matrimony_profiles: ["id"], newsletter_campaigns: ["id"], newsletter_settings: ["site_id", "section_key"], newsletter_subscribers: ["id"], notifications: ["id"], public_content_requests: ["id"], public_visibility_controls: ["email"], radio_team_members: ["id"], social_media_stats: ["site_id", "platform"], sponsors: ["id"], team_members: ["id"], user_profiles: ["user_id"], user_role_requests: ["id"], volunteer_onboarding_submissions: ["id"],
};
