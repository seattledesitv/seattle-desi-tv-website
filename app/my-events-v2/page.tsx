...
export default function MyEventsV2Page() {
  ...
  function selectEvent(id: string) { setSelectedEventId(id); setActiveTab("overview"); setDetailsOpen(false); }
