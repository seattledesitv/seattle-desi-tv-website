...
export async function createCommunityListing(kind:CommunityDirectoryKind,input:CommunityAdminInput,user:{id:string;email:string},siteId?:string|null){
 ...
 await repository.create(kind,kind==="groups"?{...common,group_url:url(input.group_url),organization_type:undefined,website:undefined,image:undefined}:{...common,website:url(input.website),group_url:undefined,platform:undefined,language:undefined},user,siteId);
}
