...
export default function BusinessesPage() {
  ...
  function validateBusinessForm() {
    return firstError(
      ...
      requireText(form.address, "Address", 5),
      validateOptionalUrl(form.website, "Website"),
      validateOptionalEmail(form.pocEmail, "POC email"),
      validateOptionalPhone(form.pocPhone, "POC phone"),
      validateOptionalImageFile(imageFiles[0], "Business image", 5)
    );
  }
  ...
  async function submitBusiness() {
    ...
    try {
      ...
      const businessPayload: any = { name: form.name.trim(), address: form.address.trim(), website: safeExternalUrl(form.website) || null, category: form.category.trim() || null, discount: form.discount.trim() || null, offer: form.offer.trim() || null, poc_name: form.pocName.trim() || null, poc_email: form.pocEmail.trim() || user.email || null, poc_phone: form.pocPhone.trim() || null, image: imageUrl || null, created_by: user.id, status: "pending", approved: false };
