...
export default function BusinessesPage() {
  ...
  async function signIn() {
    ...
    setUser(data.user || null); setPassword(""); setAuthMessage("Logged in successfully.");
  }

  async function signOut() { await supabase.auth.signOut(); setUser(null); setAuthMessage("Logged out."); }
