...
export default function BusinessesPage() {
  ...
  function validateBusinessForm() {
    return firstError(
      ...
      validateOptionalPhone(form.pocPhone, "Business contact phone"),
